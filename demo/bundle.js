...
let editor = new _basicSetup.EditorView({
  state: _basicSetup.EditorState.create({
    extensions: [_basicSetup.basicSetup, (0, _langJavascript.javascript)(), _themeOneDark.oneDarkTheme]
  }),
  parent: document.body
});

},{"@codemirror/basic-setup":4,"@codemirror/lang-javascript":12,"@codemirror/theme-one-dark":22}],3:[function(require,module,exports){
"use strict";
...
class ActiveResult extends ActiveSource {
  ...
  handleUserEvent(tr, type, conf) {
    ...
    /* Inactive */
    , false);
    if (this.span && (from == to || this.span.test(tr.state.sliceDoc(from, to)))) return new ActiveResult(this.source, this.mapExplicit(tr.changes), this.result, from, to, this.span);
...
const completionPlugin = /*@__PURE__*/_view.ViewPlugin.fromClass(class {
  ...
  accept() {
    ...
    for (let i = 0; i < this.running.length; i++) {
      ...
      if (query.done) {
        let active = new ActiveResult(query.source, query.context.explicit ? query.context.pos : -1, query.done, query.done.from, (_a = query.done.to) !== null && _a !== void 0 ? _a : cur(query.updates.length ? query.updates[0].startState : this.view.state), query.done.span ? ensureAnchor(query.done.span, true) : null); // Replay the transactions that happened since the start of
...
},{"@codemirror/language":13,"@codemirror/state":20,"@codemirror/text":21,"@codemirror/tooltip":23,"@codemirror/view":24}],4:[function(require,module,exports){
"use strict";
...
},{"@codemirror/autocomplete":3,"@codemirror/closebrackets":5,"@codemirror/commands":6,"@codemirror/comment":7,"@codemirror/fold":8,"@codemirror/gutter":9,"@codemirror/highlight":10,"@codemirror/history":11,"@codemirror/language":13,"@codemirror/lint":14,"@codemirror/matchbrackets":15,"@codemirror/rectangular-selection":18,"@codemirror/search":19,"@codemirror/state":20,"@codemirror/view":24}],5:[function(require,module,exports){
"use strict";
...
},{"@codemirror/language":13,"@codemirror/matchbrackets":15,"@codemirror/state":20,"@codemirror/text":21,"@codemirror/view":24,"lezer-tree":27}],7:[function(require,module,exports){
"use strict";
...
},{"@codemirror/state":20}],8:[function(require,module,exports){
"use strict";
...
},{"@codemirror/gutter":9,"@codemirror/language":13,"@codemirror/rangeset":17,"@codemirror/state":20,"@codemirror/view":24}],9:[function(require,module,exports){
"use strict";
...
},{"@codemirror/rangeset":17,"@codemirror/state":20,"@codemirror/view":24}],10:[function(require,module,exports){
"use strict";
...
const ruleNodeProp = /*@__PURE__*/new _lezerTree.NodeProp();
...
class HighlightStyle {
  ...
  */
  ...
  static get(state, tag, scope) {
    ...
    return style && style(tag, scope || _lezerTree.NodeType.none);
  }
...
const treeHighlighter = /*@__PURE__*/_state.Prec.fallback( /*@__PURE__*/_view.ViewPlugin.fromClass(TreeHighlighter, {
...
},{"@codemirror/language":13,"@codemirror/rangeset":17,"@codemirror/state":20,"@codemirror/view":24,"lezer-tree":27,"style-mod":29}],11:[function(require,module,exports){
"use strict";
...
const fromHistory = _state.Annotation.define();
/**
...
const isolateHistory = _state.Annotation.define();
/**
...
const historyField_ = _state.StateField.define({
  create() {
...
},{"@codemirror/state":20,"@codemirror/view":24}],12:[function(require,module,exports){
"use strict";
...
},{"@codemirror/autocomplete":3,"@codemirror/highlight":10,"@codemirror/language":13,"lezer-javascript":26}],13:[function(require,module,exports){
"use strict";
...
*/
const languageDataProp = /*@__PURE__*/new _lezerTree.NodeProp();
/**
...
const indentNodeProp = /*@__PURE__*/new _lezerTree.NodeProp(); // Compute the indentation for a given position from the syntax tree.
...
const foldNodeProp = /*@__PURE__*/new _lezerTree.NodeProp();
/**
...
},{"@codemirror/state":20,"@codemirror/text":21,"@codemirror/view":24,"lezer-tree":27}],14:[function(require,module,exports){
"use strict";
...
function maybeEnableLint(state, effects, diagnostics) {
  return state.field(lintState, false) ? effects : effects.concat(_state.StateEffect.appendConfig.of([diagnostics ? lintState.init(() => LintState.init(diagnostics, null)) : lintState, _view.EditorView.decorations.compute([lintState], state => {
    let {
      selected,
      panel
...
},{"@codemirror/panel":16,"@codemirror/state":20,"@codemirror/tooltip":23,"@codemirror/view":24,"crelt":25}],15:[function(require,module,exports){
"use strict";
...
},{"@codemirror/language":13,"@codemirror/state":20,"@codemirror/view":24,"lezer-tree":27}],16:[function(require,module,exports){
"use strict";
...
},{"@codemirror/state":20,"@codemirror/view":24}],17:[function(require,module,exports){
"use strict";
...
},{"@codemirror/state":20}],18:[function(require,module,exports){
"use strict";
...
},{"@codemirror/state":20,"@codemirror/text":21,"@codemirror/view":24}],19:[function(require,module,exports){
"use strict";
...
const selectNextOccurrence = ({
  ...
  dispatch(state.update({
    selection: state.selection.addRange(_state.EditorSelection.range(range.from, range.to)),
    scrollIntoView: true
  }));
  return true;
};
...
const searchExtensions = [searchState, /*@__PURE__*/_state.Prec.override(searchHighlighter), baseTheme];

},{"@codemirror/panel":16,"@codemirror/rangeset":17,"@codemirror/state":20,"@codemirror/text":21,"@codemirror/view":24,"crelt":25}],20:[function(require,module,exports){
"use strict";
...
},{"@codemirror/text":21}],21:[function(require,module,exports){
"use strict";
...
exports.oneDarkTheme = exports.oneDarkHighlightStyle = exports.oneDark = void 0;
...
const oneDarkHighlightStyle = /*@__PURE__*/_highlight.HighlightStyle.define([{
...
},{"@codemirror/highlight":10,"@codemirror/view":24}],23:[function(require,module,exports){
"use strict";
...
function hoverTooltip(source, options = {}) {
  ...
  return [hoverState, _view.ViewPlugin.define(view => new HoverPlugin(view, source, hoverState, setHover))];
}

},{"@codemirror/state":20,"@codemirror/view":24}],24:[function(require,module,exports){
"use strict";
...
},{"@codemirror/rangeset":17,"@codemirror/state":20,"@codemirror/text":21,"style-mod":29,"w3c-keyname":30}],25:[function(require,module,exports){
"use strict";
...
const parser = _lezer.Parser.deserialize({
  ...
  maxTerm: 321,
  nodeProps: [[_lezer.NodeProp.group, -26, 7, 14, 16, 53, 175, 179, 182, 183, 185, 188, 191, 202, 204, 210, 212, 214, 216, 219, 225, 229, 231, 233, 235, 237, 239, 240, "Statement", -30, 11, 13, 23, 26, 27, 37, 38, 39, 40, 42, 47, 55, 63, 69, 70, 83, 84, 93, 94, 110, 113, 115, 116, 117, 118, 120, 121, 139, 140, 142, "Expression", -21, 22, 24, 28, 30, 143, 145, 147, 148, 150, 151, 152, 154, 155, 156, 158, 159, 160, 169, 171, 173, 174, "Type", -2, 74, 78, "ClassItem"], [_lezer.NodeProp.closedBy, 36, "]", 46, "}", 61, ")", 123, "JSXSelfCloseEndTag JSXEndTag", 137, "JSXEndTag"], [_lezer.NodeProp.openedBy, 41, "[", 45, "{", 60, "(", 122, "JSXStartTag", 132, "JSXStartTag JSXStartCloseTag"]],
  skippedNodes: [0, 4, 5],
  repeatNodeCount: 27,
...
},{"lezer":28}],27:[function(require,module,exports){
"use strict";
...
},{"_process":1,"lezer-tree":27}],29:[function(require,module,exports){
"use strict";
